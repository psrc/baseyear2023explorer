                    ...
                    fluidPage(
                      fluidRow(
                        column(width = 2,
                               ...
                               br(),
                               helpText("Last data update: 2025-08-05")
                               ), # end column
                        column(width = 10,
                            ...
                            column(width = 2,
                                   selectInput(inputId = "pexp_queryBy",
                                               ...
                                               choices = list("Parcel ID" = "parcel_id",
                                                              ...
                                                              "Plan type ID" = "plan_type_id",
                                                              "School ID (catchment)" = "school_catchment_id"
                                               ), selected = "control_hct_id",
                                               width = '100%'
                                   ),
                                   textOutput("pexp_queryInfo"),
                                   br(),
                                   h4("Enter one or more ids"),
                                   helpText("Separate multiple ids with commas or type as range (i.e. 1000:2000)"),
                                   ...
                                   textInput("pexp_filter", label = "Filter By Expression", width = '100%'),
                                   textOutput("pexp_status_filter"),
                                   br(),
                                   textInput("pexp_color", label = "Color By Expression", width = '100%'),
                                   textOutput("pexp_status_color"),
                                   br(),
                                   textOutput("pexp_nparcels"),
                                   br(),
